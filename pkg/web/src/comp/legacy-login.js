...
/**
 * Legacy login component for meeting-specific authentication.
 * Uses num/code (password) credentials with the authenticate(num, meeting_id, password) function.
 * Used for backward compatibility with existing meetings that don't use the new organization/invite system.
 */
define("RoiLegacyLogin", {
